    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('login_type', models.CharField(choices=[('email', 'Email'), ('kakao', 'Kakao'), ('google', 'Google'), ('naver', 'Naver')], default='email', max_length=10)),
        ...
        migrations.CreateModel(
            name='RefreshToken',
            fields=[
                ('refresh_token_id', models.AutoField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='SocialAccount',
            fields=[
                ('social_account_id', models.AutoField(primary_key=True, serialize=False)),
